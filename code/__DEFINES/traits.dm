...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_LONGSTRIDER = span_info("I've been properly trained. Rough terrain doesn't slow my pace."),
	...
	TRAIT_GRAVEROBBER = span_info("My experience with 'post-mortem artifact recovery' has allowed me to resist the most basic of grave-related magical wards."),
